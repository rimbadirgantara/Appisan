...
<body>
  ...
  <!--    JavaScripts-->
  <!-- ===============================================-->
  <script src="{{ asset('adminTemplate')}}/vendors/popper/popper.min.js"></script>
    <script src="{{ asset('adminTemplate')}}/vendors/bootstrap/bootstrap.min.js"></script>
    <script src="{{ asset('adminTemplate')}}/vendors/anchorjs/anchor.min.js"></script>
    <script src="{{ asset('adminTemplate')}}/vendors/is/is.min.js"></script>
    <script src="{{ asset('adminTemplate')}}/vendors/glightbox/glightbox.min.js"> </script>
    <script src="assets/js/flatpickr.js"></script>
    <script src="{{ asset('adminTemplate')}}/vendors/echarts/echarts.min.js"></script>
    <script src="assets/data/world.js"></script>
    <script src="{{ asset('adminTemplate')}}/vendors/plyr/plyr.polyfilled.min.js"> </script>
    <script src="{{ asset('adminTemplate')}}/vendors/countup/countUp.umd.js"></script>
    <script src="{{ asset('adminTemplate')}}/vendors/chart/chart.min.js"></script>
    <script src="{{ asset('adminTemplate')}}/vendors/dropzone/dropzone.min.js"></script>
    <script src="{{ asset('adminTemplate')}}/vendors/leaflet/leaflet.js"></script>
    <script src="{{ asset('adminTemplate')}}/vendors/leaflet.markercluster/leaflet.markercluster.js"></script>
    <script src="{{ asset('adminTemplate')}}/vendors/leaflet.tilelayer.colorfilter/leaflet-tilelayer-colorfilter.min.js"></script>
    <script src="{{ asset('adminTemplate')}}/vendors/list.js/list.min.js"></script>
    <script src="{{ asset('adminTemplate')}}/vendors/tinymce/tinymce.min.js"></script>
    <script src="{{ asset('adminTemplate')}}/vendors/dayjs/dayjs.min.js"></script>
    <script src="{{ asset('adminTemplate')}}/vendors/fullcalendar/main.min.js"></script>
    <script src="{{ asset('adminTemplate')}}/vendors/fontawesome/all.min.js"></script>
    <script src="{{ asset('adminTemplate')}}/vendors/lodash/lodash.min.js"></script>
    <script src="https://polyfill.io/v3/polyfill.min.js?features=window.scroll"></script>
    <script src="{{ asset('adminTemplate')}}/vendors/list.js/list.min.js"></script>
    <script src="{{ asset('adminTemplate')}}/assets/js/theme.js"></script>
